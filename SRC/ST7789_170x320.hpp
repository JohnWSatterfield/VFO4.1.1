...
//#if MC_TYPE == S3MINI || MC_TYPE == S2MINI || MC_TYPE == S3ZERO || MC_TYPE == S3TINY || MC_TYPE == T7S3 || MC_TYPE == R8N16 || MC_TYPE == S3R8 || MC_TYPE == C3ZERO || MC_TYPE == R2040 || MC_TYPE == C3FH4 || MC_TYPE == C3MINI
