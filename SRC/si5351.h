 ...
 * 
 * Following changes made by J. Satterfield for ESP32 exception
 * Change needed to permit default i2c SDA and SCL pins
 * Note change in code on line 1346 of .cpp for ESP32 microcontroller
 *	//Wire.requestFrom(i2c_bus_addr, (uint8_t)1, (uint8_t)false); //code for arduino microcontroller
 *   Wire.requestFrom(i2c_bus_addr, (uint8_t)1); //code for ESP32 microcontroller
 * Change default SDA & SCL pins on line 38 & 39 of si5351.cpp for fixed secondary pins
 *
 */
